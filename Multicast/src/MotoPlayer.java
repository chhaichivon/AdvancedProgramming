...
public class MotoPlayer {
	...
	private void initialize() {
		...
		label.setIcon(new ImageIcon("/Users/leapkh/Developer/java/AdvancedProgramming/Multicast/img/bicycle.png"));
		label.setBounds(18, 184, 48, 28);
		frmCar.getContentPane().add(label);
	}
}
